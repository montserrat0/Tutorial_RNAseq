...
#Se importaran el countdata y el metadata
#Tomar en cuenta que la importación de paquetes BioC después de dplyr requiere el uso explícito de dplyr:: select()
#Se instalo BioCManager para poder instalar DESeq2
library(dplyr)
BiocManager::install("DESeq2")
#Para poder usar DESeq2 
library(DESeq2)

#¿Qué datos quiero usar?Uso de los datos del sailfish counts para el ejemplo del tutorial
#BrowseURL("http://dx.doi.org/10.6084/m9.figshare.1601975")
#CountDataURL= "http://files.figshare.com/2439061/GSE37704_featurecounts.csv", no se pudo descargar porque no aparecía la página, por ello lo descargué
...
ruta_csv<- "/Users/montse/Documents/Estancia Estudiantil/casos_csv/GSE37704_featurecounts.csv"

#Importar datos
countData<-read.csv(ruta_csv, row.names = 1) 
countData<-dplyr::select(countData, -length)
as.matrix(countData)
...
#Pasos Importar metadata 

#Buscar el archivo csv
file.choose()

#Copiar la ruta en la consola
rutametada_csv<- "/Users/montse/Documents/Estancia Estudiantil/casos_csv/GSE37704_metadata.csv"

#Importar metadata
colData<- read.csv(rutametada_csv, row.names = 1)
colData
...
##Ahora obtener los resultados de del knockdown de HoxA1 vs. el control siRNA, y reordenarlos por valor. 
...
#La forma canocica del Bioconductor para hacer esto es con la AnnotationDbi y paquetes de anotación del organismo. 
...
#Instalacion del paquete "gageData"
BiocManager::install("gageData")

#Instalacion del paquete "pathview"
...
#Ahora, vamos a correr el analisis de vias.
...
#Procedimiento similar con gene ontology.
#Nombrar en términos de GO
#Solo hacer el procedimiento biológico
